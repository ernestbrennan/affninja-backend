...
class KeitaroDetector implements CloakSystemDetector
{
    public const UNIQUENESS_COOKIE = 'uniqueness_cookie';
    public const VERSION = 2;
    public const ERROR = '[KTrafficClient] Something is wrong. Enable debug mode to see the reason.';
    public const MONEY_PAGE_TEXT = 'MONEY_PAGE';
    ...
    public function isSafePage(): bool
    {
        $this->sendAllParams();
        $this->params(null);
        $result = $this->execute(false, false);

        return $result !== self::MONEY_PAGE_TEXT;
    }
