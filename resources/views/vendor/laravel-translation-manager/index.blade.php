...
@section('content')
  <div class="alert alert-warning">
        После внесения изменений сообщите программисту что-бы он запустил комманду
    <b>php artisan translations:export go</b> на сервере
  </div>
              ...
              <div class="row">
                ...
                <div class=" col-sm-3">
                  ...
                  <div class="input-group input-group-sm" style="float:right; display:inline">
                    ...
                    <br>
                    <a class="btn btn-sm btn-primary" role="button" id="edit-in-place"
                ...
                <div class=" col-sm-8">
                  <div class="input-group-sm">
                    @foreach($locales as $locale)
                      ...
                      <label>
                        <input
                            <?= $locale !== $primaryLocale && $locale !== $translatingLocale ? ' class="display-locale" ' : '' ?> name="d[]"
                            type="checkbox"
                            value="<?=$locale?>"
              ...
              <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                ...
                <div class="panel-body">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <label for="keys">@lang($package . '::messages.keys')
                          :</label><?= ifEditTrans($package . '::messages.addkeys-placeholder') ?>
                      ...
                      <div class="col-sm-6">
                        <label for="suffixes">@lang($package . '::messages.suffixes')
                          :</label><?= ifEditTrans($package . '::messages.addsuffixes-placeholder') ?>
              ...
              <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                  <div class="col-sm-12">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <label for="srckeys">@lang($package . '::messages.srckeys')
                          :</label><?= ifEditTrans($package . '::messages.srckeys-placeholder') ?>
                      ...
                      <div class="col-sm-6">
                        <label for="dstkeys">@lang($package . '::messages.dstkeys')
                          :</label><?= ifEditTrans($package . '::messages.dstkeys-placeholder') ?>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div style="min-height: 10px"></div>
                        <span>@lang($package.'::messages.powered-by-yandex')</span> <span
      ...
      <div class="col-sm-12 ">
        ...
        <div class="form-inline">
          ...
          <div class="input-group input-group-sm">
            <input class="form-control" style="width: 200px;" id="show-matching-text" type="text"
                   placeholder="{{noEditTrans($package . '::messages.show-matching-text')}}">
            <span class="input-group-btn">
                            <button type="button" class="btn btn-default" id="show-matching-clear"
          ...
          <div class="input-group input-group-sm translation-filter">
            ...
            <label class="radio-inline">
              <input id="show-all" type="radio" name="show-options"
                     value="show-all"> @lang($package . '::messages.show-all')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-new" type="radio" name="show-options"
                     value="show-new"> @lang($package . '::messages.show-new')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-need-attention" type="radio" name="show-options"
                     value="show-need-attention"> @lang($package . '::messages.show-need-attention')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-nonempty" type="radio" name="show-options"
                     value="show-nonempty"> @lang($package . '::messages.show-nonempty')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-used" type="radio" name="show-options"
                     value="show-used"> @lang($package . '::messages.show-used')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-unpublished" type="radio" name="show-options"
                     value="show-unpublished"> @lang($package . '::messages.show-unpublished')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-empty" type="radio" name="show-options"
                     value="show-empty"> @lang($package . '::messages.show-empty')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-changed" type="radio" name="show-options"
                     value="show-changed"> @lang($package . '::messages.show-changed')
            </label>
          </div>
          <div class="input-group input-group-sm translation-filter">
            <label class="radio-inline">
              <input id="show-deleted" type="radio" name="show-options"
                     value="show-deleted"> @lang($package . '::messages.show-deleted')
            </label>
          </div>
        </div>
      </div>
